...
public class ParComputerPlayer1 extends GameComputerPlayer implements ParGamePlayer{

	public ParComputerPlayer1(String name) {
		super(name);
	}
	...
	protected void receiveInfo(GameInfo info) {
		...
		for(int i =0; i<possibleMoves.length; ++i){
			if(possibleMoves[i]){
				...
				//normal move for the second dice
				if(i-dice[1] >=0 ){
					if(dice[1]!=-1){
